 ...
 *   types.js        — type_spec, type definitions, D15 name-site
 *   declarations.js — declare items, cursors, nested subprograms, opaque spans
...
export default grammar({
  ...
  // D3 — five conceptual supertypes. Live TS supertypes: literal, expression,
  // statement, declaration. `type` is type_spec | parameter_type (grammar/types.js);
  // it is not listed here because an unused `type` choice is DCE'd, and
  // anchoring it at source_file conflicts with expression name chains.
  supertypes: ($) => [
    $.literal,
    $.expression,
    $.statement,
