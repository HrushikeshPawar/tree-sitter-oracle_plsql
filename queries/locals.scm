...
; Subprogram / package unit scopes (names per 02-blocks / 06-units)
(create_function) @local.scope
(create_procedure) @local.scope
(create_package) @local.scope
(create_package_body) @local.scope
; Nested procedure_definition / function_definition when present:
...
; --- References (best-effort; may over-capture) ---
; Prefer D15 name-site patterns when fields exist. Fallback:
